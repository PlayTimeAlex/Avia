            ...
            <div class="container">
                <div class="main-content__content">
                    ...
                    <div class="b-fullItem clearfix">
                        <div class="container__inner">
                            <h2 class="b-fullItem__title">Cessna 340 RAM</h2>
                            <div class="b-fullItem__images">
                                ...
                                <div class="b-fullItem__carusel">
                                    <ul class="slides">
                                        <li>
                                            <img src="images/content/plane3_prev.jpg" alt=""/>
                                        </li>
                                        <li>
                                            <img src="images/content/plane3_prev.jpg" alt=""/>
                                        </li>
                            ...
                            <div class="b-fullItem__description">
                                <table class="b-fullItem__features">
                                    <tr>
                                        <td>Изготовитель:</td>
                                        <td>Cesna</td>
                                    </tr>
                                ...
                                <div class="b-fullItem__content">
                                    <p>Разработан компанией Cessna. Работа по созданию самолёта началась в 1969 году и первый самолёт был представлен в 1971 году. С 1971 г. начался серийный выпуск.</p>
                                    <div class="b-fullItem__buttons">
                                        <a href="#" class="b-fullItem__button">Купить самолет</a><a href="#" class="b-fullItem__button b-fullItem__button_parts">Заказать запчасти</a>
                                    </div>
                                </div>
                            </div>
                        </div>     
